...
const AppSidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 h-screen w-[250px] bg-white border-r border-gray-200",
      ...
      >
        ...
        <Link href="/" className="text-2xl font-bold text-gray-800">
          <Image src="/navlogo.png" width={250} height={40} alt="Book Your Calendar" priority />
        </Link>
            ...
            {links.map(({ href, label, icon: Icon }) => (
              <li key={href}>
                <Link
                  href={href}
                  className={cn(
                    "flex items-center gap-3 px-4 py-3 text-gray-700 rounded-md",
